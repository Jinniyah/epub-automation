...
- Non-`.epub` ebook formats are a permanent non-goal for this version,
  ...
  `docs/requirements/00-overview-and-goals.md` §Non-goals so it isn't
...
- `docs/requirements/00-overview-and-goals.md` §Non-goals
- `docs/requirements/02-pipeline-stages.md` §Shared cross-stage
